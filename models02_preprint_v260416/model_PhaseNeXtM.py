...
class UseModel(WaveformModel):
    def __init__(self, in_channels=3, **kwargs):
        ...
        self.Level2_3 = ConvNeXtBlock(nch_l2, nch_l2, expansion_factor=4, kernel_size=base_kernel, stride=1, padding=3, dif_residual=True)
        ...
        self.Level3_3 = ConvNeXtBlock(nch_l3, nch_l3, expansion_factor=4, kernel_size=base_kernel, stride=1, padding=3, dif_residual=True)

        def level4_block():
            return ConvNeXtBlock(nch_l4, nch_l4, expansion_factor=4, kernel_size=base_kernel, stride=1, padding=3, dif_residual=True)
        ...
        self.Level4_2 = level4_block()
        self.Level4_3 = level4_block()
        self.Level4_4 = level4_block()
        self.Level4_5 = level4_block()
        self.Level4_6 = level4_block()
        self.Level4_7 = level4_block()
        self.Level4_8 = level4_block()
        self.Level4_9 = level4_block()
        self.Level4_10 = level4_block()
        self.Level4_11 = level4_block()
        self.Level4_12 = level4_block()
        self.Level4_13 = level4_block()
        self.Level4_14 = level4_block()
        self.Level4_15 = level4_block()
        self.Level4_16 = level4_block()
        self.Level4_17 = level4_block()
        self.Level4_18 = level4_block()
        self.Level4_19 = level4_block()
        self.Level4_20 = level4_block()
        self.Level4_21 = level4_block()
        self.Level4_22 = level4_block()
        self.Level4_23 = level4_block()
        self.Level4_24 = level4_block()
        self.Level4_25 = level4_block()
        self.Level4_26 = level4_block()
        self.Level4_27 = level4_block()
        ...
        self.Level5_3 = ConvNeXtBlock(nch_l5, nch_l5, expansion_factor=4, kernel_size=base_kernel, stride=1, padding=3, dif_residual=True)

        self.ASPP = ASPP(nch_l5, nch_l3, sepconv=True)

        self.Level3_a = SepConv1D(nch_l3 * 2, nch_l3, kernel_size=base_kernel, stride=1, padding=3, bias=False)
        self.Level3_b = SepConv1D(nch_l3, nch_l3, kernel_size=base_kernel, stride=1, padding=3, bias=False)

        self.Level2_a = UpSepLayer(nch_l3, nch_l2, scale_factor=2, kernel_size=base_kernel, padding=3)
        self.Level2_b = SepConv1D(nch_l2, nch_l2, kernel_size=base_kernel, stride=1, padding=3, bias=False)

        self.Level1_a = UpSepLayer(nch_l2, nch_l1, scale_factor=2, kernel_size=base_kernel, padding=3)
        self.Level1_b = SepConv1D(nch_l1, nch_l1, kernel_size=base_kernel, stride=1, padding=3, bias=False)
